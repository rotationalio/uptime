...
// Set the GitVersion via -ldflags="-X 'go.rtnl.ai/uptime/pkg.GitVersion=$(git rev-parse --short HEAD)'"
var GitVersion string

// Set the BuildDate via -ldflags="-X 'go.rtnl.ai/uptime/pkg.BuildDate=YYYY-MM-DD'"
